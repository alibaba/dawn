...
[![npm](https://img.shields.io/npm/v/dn-middleware-rollup)](https://www.npmjs.com/package/dn-middleware-rollup)
[![npm](https://img.shields.io/npm/dw/dn-middleware-rollup)](https://www.npmjs.com/package/dn-middleware-rollup)
[![Libraries.io dependency status for latest release](https://img.shields.io/librariesio/release/npm/dn-middleware-rollup)](https://libraries.io/npm/dn-middleware-rollup)<br>
![node-current](https://img.shields.io/node/v/dn-middleware-rollup)

这是一个提供使用 Rollup 打包资源文件的中间件

## 功能亮点

- 同时支持 `CJS` 、 `ESM` 、 `UMD` 三种打包格式
- 支持 `TypeScript` 代码打包及类型检查
- 大部分情况下只需要很少配置甚至无需配置
- 支持复杂的自定义配置场景
- 支持 `UMD` 格式下的代码混淆压缩和 `SourceMap`
...
透传给 `dn-middleware-babel` 的 `extraPresets` 配置项，详细说明请查看[相关文档](https://www.npmjs.com/package/dn-middleware-babel#extrapresets)
...
透传给 `dn-middleware-babel` 的 `extraPlugins` 配置项，详细说明请查看[相关文档](https://www.npmjs.com/package/dn-middleware-babel#extraplugins)
...
透传给 `dn-middleware-babel` 的 `nodeVersion` 配置项，详细说明请查看[相关文档](https://www.npmjs.com/package/dn-middleware-babel#nodeversion)
