...
module.exports = function (opts) {
  ...
  return async function (next) {
    ...
    this.webpackVersion = 4;
    this.webpackRunBySelf = true;
    ...
    config.module.loaders = config.module.rules; // 兼容老插件操作旧的loader配置下项
    ...
    delete config.module.loaders; // 创建实例前删除，避免webpack check option报错
    ...
    if (!this.webpackRunBySelf) return;
